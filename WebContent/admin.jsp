...
<center>
<h1>Administrator Menu</h1><br><br>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-1 pad">
<a href="#"><button class="btn btn-default btn-block btn-h" >Users</button></a>
</div>
<div class="col-md-4 col-md-offset-2 pad">
<a href="#"><button class="btn btn-default btn-block btn-h">Volunteers</button></a>
</div>
<div class="col-md-4 col-md-offset-1 pad">
<a href="#"><button class="btn btn-default btn-block btn-h">Charities</button></a>
</div>
<div class="col-md-4 col-md-offset-2 pad">
<a href="#"><button class="btn btn-default btn-block btn-h">Inventory</button></a>
</div>
